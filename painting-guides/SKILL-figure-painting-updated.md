...
1. **Memory files** (highest authority — user-specific data):
   - `paint-inventory.md` — what paints Brent actually owns; never suggest outside this
...
3. **Template HTML** — starting point: `C:\Users\brent\OneDrive\Documents\Claude\Projects\Figure Painting\painting-guides\figure-guide-template.html`
...
### Pro Acryl (Primary / Preferred)

Always reach for Pro Acryl first. Include product code alongside every name.

**Complete Pro Acryl Standard Range (with codes):**

*Skin & Flesh:* Peach Flesh 008 · Tan Flesh 024 · Shadow Flesh 042 · Warm Flesh 073 · Dark Warm Flesh S08 · Olive Flesh 041 · Advanced Flesh Tone S17 · Bright Shadow Flesh S41 · Dark Flesh 068 · Beige Red S05
...
*Reds:* Bold Pyrrole Red 003 · Burnt Red 008 · Black Red 004 · Burgundy 069 · Dark Burgundy S15 · Dark Crimson S19 · Mahogany 009 · Red Orange 017 · Orange Red S31 · Red Oxide S37

*Oranges & Yellows:* Orange 007 · NOVA Orange S49 · Burnt Orange 037 · Orange Oxide S38 · Orange Yellow 007 · Warm Yellow 072 · Golden Yellow 006 · Yellow Ochre 038 · Bright Yellow Ochre S29 · Bismuth Yellow S36 · Pale Yellow 060 · Bright Pale Yellow S30
...
*Blues:* Blue 005 · Dark Navy Blue 005 · Dark Blue 034 · Dark Grey Blue 014 · Faded Ultramarine 013 · Sky Blue 012 · Ultramarine S35 · Blue Black 056 · Grey Blue 055 · White Blue S04 · Bright Green Blue 009 · Payne's Grey S02
...
- **Primer Taupe** — mid-value warm neutral; excellent zenithal mid-tone over black for warm-toned figures.
- **P-005 Dark Neutral Gray** — versatile mid-dark grey; best all-purpose zenithal for most figures.
- **Primer Red Oxide** — warm dark red-brown; ambient occlusion for warm metallic surfaces, leather, rust.
- **Primer Dark Purple** — deep cool pre-shade; cold OSL, magical subjects, blue-purple shadow palettes.
...
Brent owns the **full Expert Acrylics line** (Series 1 + Series 2). Heavy-body artist-grade acrylics — distinct from the dropper-bottle range. Very pigment-dense, excellent for glazing and drybrushing.
...
### When Pro Acryl Doesn't Have the Right Color

Accuracy before brand loyalty. Priority order:

1. **Pro Acryl Standard** — preferred for all airbrush and dropper-bottle work
2. **Pro Acryl Expert Acrylics** — preferred for brush-only recipes and glazing
3. **Army Painter Warpaints Fanatic** — excellent range; use Flexible Triad System for value-mapped triads
4. **Army Painter Speedpaint 2.0** — valid for one-pass basecoat+shade or as a filter/glaze over sealed surface
5. **Citadel** — Brent owns **Agrax Earthshade and Nuln Oil only**. Do not suggest any other Citadel paint.
6. **Vallejo Model/Game Color** — precise and thin; good for glazing
7. **All other brands** — do not suggest unless Brent explicitly asks
...
- **Creator credit** — figure's manufacturer or sculptor (Hot Toys, Mezco, Sideshow, etc.). NOT Brent. Include social link if available.
- **Guide footer** — always constant: `brent_the_programmer` → `https://www.youtube.com/@brent_the_programmer9108` and `@stephenson913` → `https://instagram.com/stephenson913`. Never a placeholder.
...
**Steps:**
1. **Gloss Black base coat** — apply a thin, even gloss black over the entire metal surface (Satin Black S39 + a drop of gloss medium, or dedicated gloss black lacquer). Not primer black — needs to be glossy to create a reflective ground.
...
3. **Apply mid-metallic as a semi-transparent layer** — Steel 010 or Silver 025 thinned 1:3 to 1:4, airbrushed only onto light-facing planes. Multiple thin passes. The gloss black shows through on shadow planes naturally — do not paint those.
4. **Bright edge highlight** — Magnesium S42 or Silver 025 + Heavy Warm White S18, applied only to apex edges and specular peaks. Keep it tight and localized.
5. **Targeted recess wash (optional)** — Black Wash 200 or Nuln Oil only where mechanical recesses (bolts, seams, grooves) need deepening. The gloss black base already handles broad shadow zones.
6. **Colored metallics (Gold, Bronze, Copper)** — same gloss black base, then apply the colored metallic (Rich Gold 028, Bronze 032, Copper 027) semi-transparently over light planes only. Shadow warm metals with a glaze of Transparent Brown 052 or Burnt Umber (Expert Acrylics) in recesses.
...
Add an NMM sub-tab when NMM is appropriate for the figure (display pieces, stylized/artistic looks, requests from Brent). Use the sub-tab pattern: TMM primary, NMM as `<div class="sub-tab">` sibling.

**When to add NMM:** Ask Brent. Do not assume.
...
For every figure with paintable skin, read `skin-painting-methods.md` from memory for the full canonical content: all three methods (Basic, Pinkle, Wash Tinting), freckling, mid-tone reference table, and decision table. Present all three methods in the Skin tab with the recommended one flagged.
...
- **Do NOT recommend alcohol inks** — Brent does not own them.
...
`C:\Users\brent\OneDrive\Documents\Claude\Projects\Figure Painting\painting-guides\figure-guide-template.html`
...
- Creator credit — figure's manufacturer/sculptor (NOT Brent)
- Guide footer — always constant (brent_the_programmer + @stephenson913)
...
| Fair / warm             | Warm Flesh 073 / Peach Flesh 008        | Barbarian Flesh · Agate Skin · Moonstone Skin (Rose 2)            |
...
Then proceed with the corrected recipe. This is quality control. Brent has
...
```
Base:     C:\Users\brent\OneDrive\Documents\Claude\Projects\Figure Painting\painting-guides\
Category: by-category\[folder]\
Filename: [kebab-case-character-name]-painting-guide.html
```

Never ask Brent for the path — derive it from the character name and category.
...
1. **User-supplied image** — if Brent provides one, use it directly
...
**Save location:**
```
C:\Users\brent\OneDrive\Documents\Claude\Projects\Figure Painting\painting-guides\by-category\[folder]\img\[character-name]-reference.jpg
```
...
Index: `C:\Users\brent\OneDrive\Documents\Claude\Projects\Figure Painting\painting-guides\index.html`
