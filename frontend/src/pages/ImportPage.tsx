        ...
        {phase === "idle" && (
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gray-800 hover:bg-gray-700 border border-gray-700 text-gray-300 text-sm font-medium disabled:opacity-40 transition-colors"
            >
              <Play size={14} />
              Quick import (whole folder)
            </button>
          </div>
        )}
